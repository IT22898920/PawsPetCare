        ...
        <>
            <header>
                ...
                <nav className="navbar">
                    ...
                    <Link to="/user/doctors">Chaneling</Link>
            ...
            <section className="gallery" id="gallery">
                <h1 className="heading"><span>our Pet  gallery </span></h1>
            ...
            <section className="order" id="order">
                <h1 className="heading"><span>apply doctor</span></h1>
                <div className="row">

                    <div className="image">
                        <img src="https://img.freepik.com/free-vector/hand-drawn-veterinary-center-facebook-template_23-2149738524.jpg?t=st=1715629456~exp=1715633056~hmac=96bc0131b935e64bcfac6141fd30accd5e2e1a89fc334d3d737e29e592eb8aa6&w=1060" alt="Order Image" />
                    </div>

                    <form action="">
                      <p>"Apply Doctor" streamlines job searches for healthcare professionals. It offers tailored job listings, application tracking, interview prep, networking, and contract management. Our platform prioritizes privacy, security, and mobile accessibility, empowering users to advance their careers with ease. Join today and take control of your medical career!</p>
                      <button onClick={() => navigate('/apply-doctor')}className="btn">Apply Doctor</button>
                    </form>
                </div>
            </section>
            {/* order section ends */}
