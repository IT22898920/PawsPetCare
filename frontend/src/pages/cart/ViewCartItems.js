                ...
                <div className="modal-content">
                  ...
                  <form onSubmit={handleCheckout}>
                    <div className="form-group">
                      ...
                      <input type="text" defaultValue={totalPrice} readOnly className="form-control" id="exampleInputPassword1" placeholder="Total" />
                    </div>
                    <div className="form-group">
                      <label htmlFor="exampleInputAddress">Name</label>
                      <input type="text" value={userName} className="form-control" id="name" name="name" placeholder="Enter name" />
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                      ...
                      <input type="number" className="form-control" id="phoneNumber" name="phoneNumber" placeholder="Enter mobile number" />
                    </div>
